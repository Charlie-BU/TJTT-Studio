				...
				<view class="kuang shadow">
					...
					<view class="form-group">
						...
						<view class="input_section">
							...
							<input maxlength="100" class="ipt tpyA" v-model="title"
								placeholder="请输入通知/公告标题" />
						</view>
						<view class="input_section">
							<view class="title ipt">内容：</view>
							<textarea maxlength="-1" class="ipt tpyA" style="height: 150rpx;"
								v-model="content" placeholder="请输入通知/公告内容" />
						</view>
					</view>
	...
	export default {
		...
		methods: {
			...
			issue() {
				...
				fetch_data("POST", "issue_notice", data, "application", res => {
					wx.showToast({
