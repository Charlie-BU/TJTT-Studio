					...
					<view class="form-group">
						...
						<view class="input_section">
							...
							<radio-group @change="which_gender">
								<label v-if="user.gender=='男'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
								...
								<label v-if="user.gender=='女'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
						...
						<view class="input_section">
							...
							<picker mode="region" class="ipt tpyA" @change="pick_addr">
								<view style="color: #828182;">{{ address ? address : user.address }} <u-icon name="arrow-down" size="28" /></view>
							</picker>
						</view>
						<view class="input_section">
							<view class="title ipt">手机号：</view>
							<input maxlength="100" class="ipt tpyA" v-model="phone" v-bind:placeholder="user.phone" />
						</view>
						<view class="input_section">
							<view class="title ipt">邮箱：</view>
							<input maxlength="100" class="ipt tpyA" v-model="email" v-bind:placeholder="user.email" />
						</view>
						<view class="input_section">
							<view class="title ipt">学校：</view>
							<input maxlength="100" class="ipt tpyA" v-model="school" v-bind:placeholder="user.school" />
						</view>
						<view class="input_section">
							<view class="title ipt">身份：</view>
							<radio-group @change="which_role">
								<label v-if="user.role=='学生'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
								...
								<label v-if="user.role=='教师'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
								...
								<label v-if="user.role=='校友及校外人士'" class="radio" style="white-space: pre-wrap;">\n&nbsp;
						...
						<view class="input_section">
							...
							<input maxlength="100" class="ipt tpyA" v-model="stu_num" v-bind:placeholder="user.stu_num" />
						</view>
						<view class="input_section">
							<view class="title ipt">执拍手：</view>
							<radio-group @change="which_hand">
								<label v-if="user.hand=='右手'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
								...
								<label v-if="user.hand=='左手'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
						...
						<view class="input_section">
							...
							<radio-group @change="which_grip">
								<label v-if="user.grip=='横拍'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
								...
								<label v-if="user.grip=='直拍'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
						...
						<view class="input_section">
							...
							<input maxlength="100" class="ipt tpyA" v-model="blade" v-bind:placeholder="user.blade" />
						</view>
						<view class="input_section">
							<view class="title ipt">正手胶皮：</view>
							<input maxlength="100" class="ipt tpyA" v-model="forehand" v-bind:placeholder="user.forehand" />
						</view>
						<view class="input_section">
							<view class="title ipt">反手胶皮：</view>
							<input maxlength="100" class="ipt tpyA" v-model="backhand" v-bind:placeholder="user.backhand" />
						</view>
						<view class="input_section">
							<view class="title ipt">是否带颗粒：</view>
							<radio-group @change="which_particle">
								<label v-if="user.particle=='是'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
								...
								<label v-if="user.particle=='否'" class="radio" style="margin-left: 15rpx; margin-right: 20rpx;">
