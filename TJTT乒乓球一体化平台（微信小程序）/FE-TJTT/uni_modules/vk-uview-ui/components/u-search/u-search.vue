	...
	<view class="u-search" @tap="clickHandler" :style="{
		...
		>
			<view class="u-icon-wrap">
				<u-icon class="u-clear-icon" :size="30" :name="searchIcon" :color="searchIconColor ? searchIconColor : color" />
			</view>
			<input
				confirm-type="search"
				@blur="blur"
			...
			<view class="u-close-wrap" v-if="keyword && clearabled && focused" @tap="clear">
				<u-icon class="u-clear-icon" name="close-circle-fill" size="34" color="#c0c4cc" />
			</view>
		</view>
