<template>
	<view class="u-upload" v-if="!disabled">
		...
		>
			...
			>
				<u-icon class="u-icon" :name="delIcon" size="20" :color="delColor" />
			</view>
			<!-- <view
				v-if="item.progress >= 100"
				class="u-success-icon"
			>
				<u-icon class="u-icon" :name="successIcon" size="20" :color="successColor" />
			</view> -->
			<u-line-progress
		...
		<view style="display: inline-block;" @tap="selectFile" v-if="maxCount > lists.length">
			...
			>
				<u-icon name="plus" class="u-add-btn" size="40" />
